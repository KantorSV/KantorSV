 ...
 * 
 */
@WebServiceClient(name = "PersonServiceService", targetNamespace = "http://app.com/", wsdlLocation = "http://127.0.0.1:8083/person?WSDL")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICESERVICE_QNAME = new QName("http://app.com/", "PersonServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8083/person?WSDL");
    ...
    public PersonService getPersonServicePort() {
        return super.getPort(new QName("http://app.com/", "PersonServicePort"), PersonService.class);
    }
    ...
    public PersonService getPersonServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://app.com/", "PersonServicePort"), PersonService.class, features);
    }
