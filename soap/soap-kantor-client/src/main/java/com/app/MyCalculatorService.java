 ...
 * 
 */
@WebServiceClient(name = "MyCalculatorService", targetNamespace = "http://app.com/", wsdlLocation = "http://127.0.0.1:8085/Kantor?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8085/Kantor?wsdl");
