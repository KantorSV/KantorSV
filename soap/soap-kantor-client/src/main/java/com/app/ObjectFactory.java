...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://app.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://app.com/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://app.com/", "addResponse");
    private final static QName _ProductResponse_QNAME = new QName("http://app.com/", "productResponse");
    private final static QName _Add_QNAME = new QName("http://app.com/", "add");
    private final static QName _Product_QNAME = new QName("http://app.com/", "product");
    private final static QName _DivideResponse_QNAME = new QName("http://app.com/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://app.com/", "divide");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app.com/", name = "productResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app.com/", name = "product")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://app.com/", name = "divide")
