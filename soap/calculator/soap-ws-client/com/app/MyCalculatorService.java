 ...
 * 
 */
@WebServiceClient(name = "MyCalculatorService", targetNamespace = "http://app.com/", wsdlLocation = "http://127.0.0.1:8083/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYCALCULATORSERVICE_QNAME = new QName("http://app.com/", "MyCalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8083/calculator?wsdl");
    ...
    public MyCalculator getMyCalculatorPort() {
        return super.getPort(new QName("http://app.com/", "MyCalculatorPort"), MyCalculator.class);
    }
    ...
    public MyCalculator getMyCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://app.com/", "MyCalculatorPort"), MyCalculator.class, features);
    }
